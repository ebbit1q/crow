...
_CARDTOMOVE = DESCRIPTOR.message_types_by_name['CardToMove']
_LISTOFCARDSTOMOVE = DESCRIPTOR.message_types_by_name['ListOfCardsToMove']
_COMMAND_MOVECARD = DESCRIPTOR.message_types_by_name['Command_MoveCard']
