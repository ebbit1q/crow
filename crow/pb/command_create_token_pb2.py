...
_COMMAND_CREATETOKEN = DESCRIPTOR.message_types_by_name['Command_CreateToken']
_COMMAND_CREATETOKEN_TARGETMODE = _COMMAND_CREATETOKEN.enum_types_by_name['TargetMode']
